<template>
  <nav :class="['navbar', { scrolled: isScrolled || !isHomePage, 'menu-open': isMenuOpen }]">
        ...
        <div class="navbar-nav-wrapper">
          <div :class="['navbar-menu', { active: isMenuOpen }]">
            <div class="navbar-links">
              <NuxtLink v-for="item in menuItems" :key="item.href" :to="item.href" class="navbar-link" @click="closeMenu">
                {{ item.label }}
              </NuxtLink>
            </div>
