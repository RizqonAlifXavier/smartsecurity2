...
export const brands: Brand[] = [
  ...
  { id: 'gst', name: 'GST', category: 'fire-alarm', categoryLabel: 'Fire Alarm', logo: 'GST', logoImage: '/brands/GST.jpg', description: 'Reliable conventional and addressable fire alarm systems' },
...
export const products: Product[] = [
  ...
  // GENETEC Products
  // =====================================================================
  { id: 1039, name: 'Sevurity Center (SaaS)', category: 'genetec-saas', categoryLabel: 'SECURITY CENTER AS A SERVICE', brand: 'genetec', description: 'GENETEC Sevurity Center (SaaS)', price: 'Contact Us', features: [], icon: '☁️' },
  ...
  { id: 1044, name: 'Securiy Center', category: 'genetec-on-premise', categoryLabel: 'ON-PREMISE PLATFORM', brand: 'genetec', description: 'GENETEC Securiy Center', price: 'Contact Us', features: [], icon: '🏢' },
  ...
  { id: 1070, name: 'Genetec Operations Center', category: 'genetec-operations', categoryLabel: 'OPERATIONS & COLABORATION', brand: 'genetec', description: 'GENETEC Genetec Operations Center', price: 'Contact Us', features: [], icon: '🤝' },
  ...
  { id: 1086, name: 'OnGuard Credentials', category: 'lenel-mobile-credential', categoryLabel: 'MOBILE CREDENTIAL', brand: 'lenel', description: 'LENEL OnGuard Credentials', price: 'Contact Us', features: [], icon: '📱' },
  ...
  { id: 1090, name: 'Milestone Xprotect', category: 'lenel-video-management', categoryLabel: 'VIDEO MANAGEMENT', brand: 'lenel', description: 'LENEL Milestone Xprotect', price: 'Contact Us', features: [], icon: '📹' },
